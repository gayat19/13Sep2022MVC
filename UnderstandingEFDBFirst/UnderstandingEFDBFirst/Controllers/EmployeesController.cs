...
namespace UnderstandingEFDBFirst.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        {
            var pubsContext = _context.Employee.Include(e => e.Job).Include(e => e.Pub);
        ...
        {
            ViewData["JobId"] = new SelectList(_context.Jobs, "JobId", "JobDesc");
        ...
        public async Task<IActionResult> Create([Bind("EmpId,Fname,Minit,Lname,JobId,JobLvl,PubId,HireDate")] Employee employee)
        {
            ...
            ViewData["JobId"] = new SelectList(_context.Jobs, "JobId", "JobDesc", employee.JobId);
